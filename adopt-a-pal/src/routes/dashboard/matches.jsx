...
function Matches({ palDataList, loading, uid }) {
  ...
  return (
    <>
      <div className="w-[80vw] flex flex-col flex-wrap mt-28 mb-10 mx-auto px-12 justify-center ">
        {/* PAGE TITLE */}
        ...
        <div className="grid 2xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 auto-cols-auto gap-5 justify-items-center mb-32 md:mx-0 mx-8">
          {loading && (
            <div
