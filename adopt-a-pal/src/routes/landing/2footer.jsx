const Footer = () => {
  return (
    <>
      {/* LINE */}
      <div className="w-full h-px bg-white rounded-t-[55px] shadow-xl mt-20 mb-8"></div>
      {/* FOOTER */}
      <div className="px-5 max-w-[80vw] mx-auto">
        {/* TOP */}
        <div className="flex justify-between gap-t-10 flex-wrap">
          {/* TOP-LEFT */}
          <div className="">
            <div className="flex items-center gap-2 mb-3">
              {/* LOGO */}
              <div className="flex gap-2 items-center text-3xl text-[#714949] font-bold">
                <svg
                  width="35"
                  height="35"
                  viewBox="0 0 64 64"
                ...
                <span className="opacity-60">Adopt-a-Pal</span>
              </div>
              {/* CALL TO ACTION */}
              <div className="text-[55px] text-[#714949] font-bold">
        ...
        {/* BOTTOM */}
        <div className="text-center text-[#714949] text-[20px] pb-8 mt-12">
          © All Rights Reserved
        </div>
      </div>
    </>
